...
# TEXT_SCALE is the max text length EAST can detect,
...
# because i think your model should be able to fit all the data used in training.
...
def model(images, weight_decay=1e-5, is_training=True):
    ...
    Returns:
        predicted score masks, predicted geometry masks
    """
...
def loss(y_true_cls, y_pred_cls, y_true_geo, y_pred_geo, training_mask):
    ...
    :param y_true_cls: ground truth of text (score masks)
    :param y_pred_cls: prediction os text (predicted score masks)
